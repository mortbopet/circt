...
handshake.func @invalid_operand_count(%data:f32, %staddress: index, %ldaddress: index) -> (f32, none, none) {
  ...
  %0:3 = "handshake.memory"(%data, %staddress, %ldaddress)
    {id = 0 : i32, ld_count = 0 : i32, lsq = false, st_count = 1 : i32, type = memref<10xf32>} : (f32, index, index) -> (f32, none, none)
...
handshake.func @invalid_result_count(%data:f32, %staddress: index, %ldaddress: index) -> (f32, none) {
  ...
  %0:2 = "handshake.memory"(%data, %staddress, %ldaddress)
    {id = 0 : i32, ld_count = 1 : i32, lsq = false, st_count = 1 : i32, type = memref<10xf32>} : (f32, index, index) -> (f32, none)
...
handshake.func @invalid_address_type(%data:f32, %staddress: f32, %ldaddress: index) -> (f32, none, none) {
  ...
  %0:3 = "handshake.memory"(%data, %staddress, %ldaddress)
    {id = 0 : i32, ld_count = 1 : i32, lsq = false, st_count = 1 : i32, type = memref<10xf32>} : (f32, f32, index) -> (f32, none, none)
  return %0#0, %0#1, %0#2 : f32, none, none
}
...
handshake.func @invalid_store_data_type(%data:i32, %staddress: index, %ldaddress: index) -> (f32, none, none) {
  ...
  %0:3 = "handshake.memory"(%data, %staddress, %ldaddress)
    {id = 0 : i32, ld_count = 1 : i32, lsq = false, st_count = 1 : i32, type = memref<10xf32>} : (i32, index, index) -> (f32, none, none)
  return %0#0, %0#1, %0#2 : f32, none, none
}
...
handshake.func @invalid_load_data_type(%data:f32, %staddress: index, %ldaddress: index) -> (f32, none, none) {
  ...
  %0:3 = "handshake.memory"(%data, %staddress, %ldaddress)
    {id = 0 : i32, ld_count = 1 : i32, lsq = false, st_count = 1 : i32, type = memref<10xf32>} : (f32, index, index) -> (i32, none, none)
  return %0#0, %0#1, %0#2 : i32, none, none
}

// -----

handshake.func @invalid_multidim_address(%data:f32, %staddress: index, %ldaddress: index) -> (f32, none, none) {
  // expected-error @+1 {{number of operands 3 does not match number expected of 3 with 2 address inputs per port}}
  %0:3 = "handshake.memory"(%data, %staddress, %ldaddress)
    {id = 0 : i32, ld_count = 1 : i32, lsq = false, st_count = 1 : i32, type = memref<2x5xf32>} : (f32, index, index) -> (f32, none, none)
  return %0#0, %0#1, %0#2 : f32, none, none
}
