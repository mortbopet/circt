...
// CHECK:           %[[VAL_1:.*]]:18 = fork(%[[VAL_0]]) {control = true} : (none) -> (none, none, none, none, none, none, none, none, none, none, none, none, none, none, none, none, none, none)
// CHECK:           %[[VAL_2:.*]] = constant(%[[VAL_1]]#16) {value = 0 : index} : (none) -> index
// CHECK:           %[[VAL_3:.*]]:2 = fork(%[[VAL_2]]) : (index) -> (index, index)
// CHECK:           %[[VAL_4:.*]] = constant(%[[VAL_1]]#15) {value = 101 : index} : (none) -> index
// CHECK:           sink(%[[VAL_4]]) : (index) -> ()
// CHECK:           %[[VAL_5:.*]] = constant(%[[VAL_1]]#14) {value = 102 : index} : (none) -> index
// CHECK:           sink(%[[VAL_5]]) : (index) -> ()
// CHECK:           %[[VAL_6:.*]] = arith.addi %[[VAL_3]]#0, %[[VAL_3]]#1 : index
// CHECK:           %[[VAL_7:.*]] = constant(%[[VAL_1]]#13) {value = 1 : index} : (none) -> index
// CHECK:           %[[VAL_8:.*]] = arith.addi %[[VAL_6]], %[[VAL_7]] : index
// CHECK:           sink(%[[VAL_8]]) : (index) -> ()
// CHECK:           %[[VAL_9:.*]] = constant(%[[VAL_1]]#12) {value = 103 : index} : (none) -> index
// CHECK:           %[[VAL_10:.*]] = constant(%[[VAL_1]]#11) {value = 104 : index} : (none) -> index
// CHECK:           %[[VAL_11:.*]] = constant(%[[VAL_1]]#10) {value = 105 : index} : (none) -> index
// CHECK:           %[[VAL_12:.*]] = constant(%[[VAL_1]]#9) {value = 106 : index} : (none) -> index
// CHECK:           %[[VAL_13:.*]] = constant(%[[VAL_1]]#8) {value = 107 : index} : (none) -> index
// CHECK:           %[[VAL_14:.*]] = constant(%[[VAL_1]]#7) {value = 108 : index} : (none) -> index
// CHECK:           %[[VAL_15:.*]] = constant(%[[VAL_1]]#6) {value = 109 : index} : (none) -> index
// CHECK:           %[[VAL_16:.*]] = constant(%[[VAL_1]]#5) {value = 2 : index} : (none) -> index
// CHECK:           %[[VAL_17:.*]] = arith.muli %[[VAL_10]], %[[VAL_16]] : index
// CHECK:           %[[VAL_18:.*]] = arith.addi %[[VAL_9]], %[[VAL_17]] : index
// CHECK:           %[[VAL_19:.*]] = constant(%[[VAL_1]]#4) {value = 3 : index} : (none) -> index
// CHECK:           %[[VAL_20:.*]] = arith.muli %[[VAL_11]], %[[VAL_19]] : index
// CHECK:           %[[VAL_21:.*]] = arith.addi %[[VAL_18]], %[[VAL_20]] : index
// CHECK:           %[[VAL_22:.*]] = constant(%[[VAL_1]]#3) {value = 4 : index} : (none) -> index
// CHECK:           %[[VAL_23:.*]] = arith.muli %[[VAL_12]], %[[VAL_22]] : index
// CHECK:           %[[VAL_24:.*]] = arith.addi %[[VAL_21]], %[[VAL_23]] : index
// CHECK:           %[[VAL_25:.*]] = constant(%[[VAL_1]]#2) {value = 5 : index} : (none) -> index
// CHECK:           %[[VAL_26:.*]] = arith.muli %[[VAL_13]], %[[VAL_25]] : index
// CHECK:           %[[VAL_27:.*]] = arith.addi %[[VAL_24]], %[[VAL_26]] : index
// CHECK:           %[[VAL_28:.*]] = constant(%[[VAL_1]]#1) {value = 6 : index} : (none) -> index
// CHECK:           %[[VAL_29:.*]] = arith.muli %[[VAL_14]], %[[VAL_28]] : index
// CHECK:           %[[VAL_30:.*]] = arith.addi %[[VAL_27]], %[[VAL_29]] : index
// CHECK:           %[[VAL_31:.*]] = constant(%[[VAL_1]]#0) {value = 7 : index} : (none) -> index
