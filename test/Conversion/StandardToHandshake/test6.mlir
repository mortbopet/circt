...
// CHECK:           %[[VAL_6:.*]] = merge(%[[VAL_1]]) : (f32) -> f32
// CHECK:           %[[VAL_7:.*]]:3 = fork(%[[VAL_6]]) : (f32) -> (f32, f32, f32)
// CHECK:           %[[VAL_8:.*]] = merge(%[[VAL_2]]) : (i32) -> i32
// CHECK:           %[[VAL_9:.*]]:9 = fork(%[[VAL_8]]) : (i32) -> (i32, i32, i32, i32, i32, i32, i32, i32, i32)
// CHECK:           %[[VAL_10:.*]] = merge(%[[VAL_3]]) : (i32) -> i32
// CHECK:           %[[VAL_11:.*]]:8 = fork(%[[VAL_10]]) : (i32) -> (i32, i32, i32, i32, i32, i32, i32, i32)
// CHECK:           %[[VAL_12:.*]] = arith.subf %[[VAL_5]], %[[VAL_7]]#2 : f32
// CHECK:           %[[VAL_13:.*]]:3 = fork(%[[VAL_12]]) : (f32) -> (f32, f32, f32)
// CHECK:           %[[VAL_14:.*]] = arith.subi %[[VAL_9]]#8, %[[VAL_11]]#7 : i32
// CHECK:           %[[VAL_15:.*]]:2 = fork(%[[VAL_14]]) : (i32) -> (i32, i32)
// CHECK:           %[[VAL_16:.*]] = arith.cmpi slt, %[[VAL_9]]#7, %[[VAL_15]]#1 : i32
// CHECK:           %[[VAL_17:.*]] = arith.subi %[[VAL_9]]#6, %[[VAL_11]]#6 : i32
// CHECK:           %[[VAL_18:.*]]:2 = fork(%[[VAL_17]]) : (i32) -> (i32, i32)
